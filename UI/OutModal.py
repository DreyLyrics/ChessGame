"""
UI/OutModal.py
Modal xác nhận thoát trận online.
Trả về: 'quit' | 'continue'
"""
...
C_CONTINUE_BG  = (50, 130, 220)
C_CONTINUE_HOV = (80, 160, 255)
C_QUIT_BG      = (160, 50, 50)
...
class OutModal:
    ...
    def _build(self):
        ...
        pad = 32; iw = self.W - pad * 2
        self.btn_continue = Button(
            mx + pad, my + 90, iw, 46,
            text='Tiep tuc',
            bg=C_CONTINUE_BG, bg_hover=C_CONTINUE_HOV,
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYDOWN:
                    if event.key in (pygame.K_ESCAPE, pygame.K_m):
                        self._result = 'continue'   # ESC/M đóng modal → tiếp tục
